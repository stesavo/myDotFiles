...
"   URL:         github.com/stesavo/protanone
"   License:     The MIT License (MIT)
"
"   A dark vim color scheme based on github.com/sonph/onehalf
"   Might be well suited for people with protanopia
" ==============================================================================
...
let g:colors_name="protanone"
let colors_name="protanone"
...
let s:fg          = { "gui": "#afb1bf", "cterm": "188"}
let s:bg          = s:black

let s:comment_fg  = { "gui": "#7d8799", "cterm": "241" }
...
call s:h("Special", s:blue, "", "italic")
...
call s:h("Todo", s:black, s:yellow, "bold,italic")
" }
