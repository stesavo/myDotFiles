...
call s:h("StatusLine", s:primary_semi_dark, s:primary_semi_bright, "bold")
...
call s:h("Conceal", s:primary_semi_dark, "", "bold")
...
call s:h("Type", s:secondary_1_semi_bright, s:primary_dark, "")
